...
if __name__ == "__main__":
    ...
    print(f"After removing compounds with identical connectivity, {len(similar_cids)} compounds left")
    ...
    drug_candidate = remove_non_drug(similar_cids, save_result=True, mol_name=mol_name)
    print(f"After removing non-drug-like structures, {len(drug_candidate)} compounds left.")
